...
var showAdOnceAfterIntermission = false;
function doShowAdOnceAfterIntermission() {
    showAdOnceAfterIntermission = true;
}
...
function updateIntermission() {
    if (state == "intermission") {
        if (intermissionTimer > 0) {
            ...
            if (showAdOnceAfterIntermission) {
                showAdOnceAfterIntermission = false;
                cmgAdBreakCall();
            }
        }
    }
