...
function loadConfig(){
	...
	client.open("GET", "./patch/playtouch/games-config.json?//games.playtouch.net/games-config/loadGameConfig.php?gamename="+_gamename+"&clientID="+_clientID+"&platform="+_platform, true);
	client.send();
	//alert('send');
}
